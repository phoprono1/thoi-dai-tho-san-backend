...
export class AddEquipmentSlotsAndTitleSystem1759040000000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_user_title_userId" ON "user_title" ("userId")`);
        await queryRunner.query(`CREATE INDEX "IDX_user_title_titleId" ON "user_title" ("titleId")`);
        await queryRunner.query(`CREATE INDEX "IDX_user_title_isEquipped" ON "user_title" ("isEquipped")`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user_title" DROP CONSTRAINT "FK_user_title_titleId"`);
        await queryRunner.query(`ALTER TABLE "user_title" DROP CONSTRAINT "FK_user_title_userId"`);
